...
from code_parser.mark_code import generate_mark_token_action
...
from common.read_data.read_filter_data_records import read_distinct_problem_user_ac_c_records_filter_error_code
from database.database_util import insert_items, create_table, run_sql_select_statment
from common.util import init_code, tokenize_by_clex_fn, compile_c_code_by_gcc, build_code_string_from_lex_tokens
...
def create_error_code(code, error_type_list=(5, 1, 4), error_count_range=(1, 5), tokenize_fn = None):
    ...
    error_tokens, _ = generate_mark_token_action(None, None, operation_list, tokens=code_tokens)
