from common.constants import ACTUAL_C_ERROR_RECORDS, CPP_TESTCASE_ERROR_RECORDS, C_COMPILE_SUCCESS_RECORDS, \
    RANDOM_C_ERROR_RECORDS, COMMON_C_ERROR_RECORDS, PROBLEM_TESTCASE
...
CREATE_PROBLEM_TESTCASE = r'''CREATE TABLE IF NOT EXISTS problem_testcase (
  id TEXT PRIMARY KEY,
  submit_url TEXT,
  problem_id TEXT,
  user_id TEXT,
...
INSERT_IGNORE_PROBLEM_TESTCASE = r'''INSERT OR IGNORE INTO problem_testcase (id, submit_url, problem_id, user_id, problem_user_id, code) VALUES (?, ?, ?, ?, ?, ?)'''
...
sql_dict = {ACTUAL_C_ERROR_RECORDS: {'create': CREATE_ACTUAL_C_ERROR_RECORDS,
            ...
            PROBLEM_TESTCASE: {'create': CREATE_PROBLEM_TESTCASE,
                               'insert_ignore': INSERT_IGNORE_PROBLEM_TESTCASE},
            }
